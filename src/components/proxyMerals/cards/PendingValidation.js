...
const PendingValidation = () => {
	...
	return (
		<div className="text-black w-full">
			<h2 className="mt-8 pb-2 text-xl text-white p-4">PENDING VALIDATION</h2>
			<div style={styleBoxshadow} className="bg-white p-4 pb-8 rounded-md">
				<div className="flex items-center py-2 pb-8">
					<span className=" text-xs ">After Registering, our validators will validate ownership. If successful the Polygon Proxy Meral will be minted and sent to your wallet</span>
				</div>
