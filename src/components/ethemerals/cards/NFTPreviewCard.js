	...
	return (
		...
		>
			<div className="text-xs font-bold absolute right-0 text-right text-white z-10">
				...
				{nft.proxy && (
					<div className="mt-2 -right-2 absolute">
						...
						<svg className="mt-1" width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div style={{ bottom: '68px' }} className="w-full absolute z-10 flex justify-end right-1 space-x-1 text-white">
				<div className="relative">
					<div style={{ transform: 'translate(0px, 2px)' }} className="bg-red-900 w-8 h-8 rounded-full shadow border border-b-4 border-red-700"></div>
					<span className="center text-red-50 font-black text-xs">{nft.atk}</span>
				</div>
				<div className="relative">
					<div style={{ transform: 'translate(0px, 2px)' }} className="bg-blue-900 w-8 h-8 rounded-full shadow border border-b-4 border-blue-700"></div>
					<span className="center text-blue-50 font-black text-xs">{nft.def}</span>
				</div>
				<div className="relative">
					<div style={{ transform: 'translate(0px, 2px)' }} className="bg-green-900 w-8 h-8 rounded-full shadow border border-b-4 border-green-700"></div>
					<span className="center text-green-50 font-black text-xs">{nft.spd}</span>
				</div>
			</div>
