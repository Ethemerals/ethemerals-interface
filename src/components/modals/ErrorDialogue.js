	...
	return (
		<>
			<div className="w-full h-full flex justify-center fixed top-0 left-0">
				...
				<div className=" w-96 h-64 center border-gray-400 bg-opacity-100 rounded-2xl overflow-hidden z-30 tracking-wide shadow-xl bg-gray-900">
					...
					<div className="center w-max text-center">
						...
						<p className="py-1 text-red-500">{message}</p>
					</div>
				</div>
			</div>
		</>
