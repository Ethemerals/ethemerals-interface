const SpinnerSVG = () => (
	<svg className=" animate-spin-slow text-brandColor" width="100" height="100" viewBox="0 0 304 304" fill="none" xmlns="http://www.w3.org/2000/svg">
		<g opacity="1">
			<path
	...
	return (
		<>
			<div className="w-full h-full flex justify-center fixed top-0 left-0 text-black z-50">
				...
				<div className=" w-11/12 max-w-420 h-96 center border-gray-400 bg-opacity-100 rounded-2xl overflow-hidden tracking-wide shadow-xl bg-white">
