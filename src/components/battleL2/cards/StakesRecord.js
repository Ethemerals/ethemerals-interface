	...
	return (
		<div className="mt-32">
			...
			<div className=" grid grid-cols-2 mt-8 items-start">
				<div style={{ minHeight: '128px' }} className="border-gray-100 border rounded-md mr-2 py-6 pt-2 bg-gray-200 bg-opacity-70">
				...
				<div style={{ minHeight: '128px' }} className=" border-gray-100 border rounded-md ml-2 py-6 pt-2 bg-gray-200 bg-opacity-70">
					<p style={{ transform: 'translate(0px, -28px)' }} className="text-white text-sm font-bold flex items-center justify-between">
