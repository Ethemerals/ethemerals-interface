	...
	return (
		<>
			...
			<div className="relative">
				<p className="text-white opacity-40 pt-16 pl-4 absolute">MAINNET BETA</p>
					...
					<div className="text-black w-full">
						...
						<div className="flex space-x-4 mt-16">
							<div onClick={() => history.push(`/register`)} className="bg-white w-1/3 rounded-md p-4 h-48 border-white border-2 bg-opacity-70 cursor-pointer hover:bg-opacity-100">
								<h2 className="mb-20">NFT VIRTUAL GATEWAY</h2>
							...
							<div className="bg-white w-1/3 rounded-md p-4 h-48 border-white border-2 bg-opacity-50">
