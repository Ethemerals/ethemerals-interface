	...
	return (
		<>
			...
			<div className="relative">
				<p className="text-white text-xl opacity-60 pt-16 pl-4 absolute">MAINNET BETA</p>
				<div style={{ minWidth: '900px', maxWidth: '900px' }} className="pt-20 mb-64 mx-auto text-black">
					{/* HEADER */}
					<div className="text-black w-full">
						<h2 className="text-6xl text-white px-4 mt-32">THE WILDS</h2>
						...
						<div className="flex space-x-4 mt-16">
							<div onClick={() => history.push(`/register`)} className="bg-white w-1/3 p-4 h-48 border-white border-2 bg-opacity-70 cursor-pointer hover:bg-opacity-100">
								<h2 className="mb-20">VIRTUAL GATEWAY</h2>
								<p className="text-sm">Send your NFTs through the virtual gateway</p>
							</div>
							<div onClick={() => history.push(`/battle/poly`)} className="bg-white w-1/3 p-4 h-48 border-white border-2 bg-opacity-70 cursor-pointer hover:bg-opacity-100">
								<h2 className="mb-20">ETERNAL BATTLE</h2>
								<p className="text-sm">Stake your Merals HP on crypto markets, earn rewards and items</p>
							</div>
							<div onClick={() => history.push(`/onsen`)} className="bg-white w-1/3 p-4 h-48 border-white border-2 opacity-20">
						...
						<div className="flex space-x-4 my-8">
							<div className="bg-white w-1/3 p-4 h-48 border-white border-2 opacity-20">
