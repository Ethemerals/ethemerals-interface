const getAddresses = () => {
	...
	let addresses = {
		...
		EthemeralBurner: '0x3b3D085078E3dAEad342A89bb2A3C2B45bC18828',
	...
	if (network === '1') {
		...
		addresses.EthemeralBurner = '0xDb128597CB3C4F4b1D3C739Dbb2c5350EA84BA0D';
		...
		addresses.BurnAddress = '0x13D8EE49CbA2Eb416584806b8D370Ff432fF5A03';
	}
