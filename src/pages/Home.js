...
const Home = () => {
	...
	return (
		<div>
			...
			></div>
			<div className="my-8 w-full sm:my-24 sm:w-500 mx-auto bg-white p-6 pt-20 pb-10 rounded-lg bg-opacity-80 relative">
				...
				{/* {contractCore ? (
					<div>
						...
						>
							<p className="">{`Mint 1 for 0.04 ETH`}</p>
						</div>
						...
						>
							<p className="">{`Mint 3 for 0.108 ETH`}</p>
						</div>
					</div>
				) : (
					<div
				...
				<div className="mt-10 mb-2 text-gray-900 text-sm">
					...
					<div className="bg-white p-4 bg-opacity-80">
						...
						<div className="justify-center flex space-x-6 mt-6">
							...
							<a href={Links.MEDIUM} target="_blank" rel="noreferrer" className="hover:text-gray-500 flex items-center">
								<span className="mr-2">MEDIUM</span>

								<svg viewBox="0 0 1043.63 592.71" width="24" height="24">
									<g data-name="Layer 2">
										<g data-name="Layer 1">
